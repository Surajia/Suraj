...
const locationMarkerUnsecureColor: Color = [0.890, 0.251, 0.224];
...
class SmoothLerp {
  private zoomAnimation: ZoomAnimation;
    ...
    public constructor(private startCoordinate: Coordinate, private path: Coordinate, startZoom: number, endZoom: number, private startTime: number, private duration: number) {
...
export default class Map {
  ...
  private animations: Array<SmoothLerp>;
    ...
    public constructor(gl: WebGL2RenderingContext, startCoordinate: Coordinate, connectionState: boolean) {
...
// position from origo
function circleFanVertices(numEdges: number, radius: number, offset: [number, number, number], centerColor: Color, ringColor: Color) {
